...
module.exports = {
  ...
  Mutation: {
    criarContato: async (_, {data}) => await (await db('contatos').insert(data).returning('*'))[0],
    atualizarContato: async (_, {id, data}) => await (await db('contatos').where({id}).update(data).returning('*'))[0],
